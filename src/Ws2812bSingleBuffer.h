...
class Ws2812bSingleBuffer {
 public:

  // Constructor: number of LEDs
  Ws2812bSingleBuffer (uint16_t number_of_leds);// Constuctor 
  ~Ws2812bSingleBuffer();
  void
    begin(void),
    show(void),
...
//   *getPixels(void) const,
 ...
 //   getPixelColor(uint16_t n) const;
   ...
   *singleBuffer,	// Holds the start of the single buffer (1 buffer for async DMA transfer and one for the API interaction.
