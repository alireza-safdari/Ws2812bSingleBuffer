...
Ws2812bSingleBuffer::Ws2812bSingleBuffer(uint16_t number_of_leds) :
...
Ws2812bSingleBuffer::~Ws2812bSingleBuffer() 
{
  if(pixels)   
  {
	  free(pixels);
...
void Ws2812bSingleBuffer::begin(void) {
...
void Ws2812bSingleBuffer::updateLength(uint16_t n)
{
  if(singleBuffer) 
  {
	  free(singleBuffer); 
  ...
  if((singleBuffer = (uint8_t *)malloc(numBytes)))
  {
    numLEDs = n;	 
	pixels = singleBuffer;
...
void Ws2812bSingleBuffer::show(void) 
{
...
*/
void Ws2812bSingleBuffer::setPixelColor(uint16_t n, uint8_t r, uint8_t g, uint8_t b)
 {
...
void Ws2812bSingleBuffer::setPixelColor(uint16_t n, uint32_t c)
  {
     uint8_t r,g,b;
...
uint32_t Ws2812bSingleBuffer::Color(uint8_t r, uint8_t g, uint8_t b) {
  return ((uint32_t)r << 16) | ((uint32_t)g <<  8) | b;
}

// Convert separate R,G,B,W into packed 32-bit WRGB color.
// Packed format is always WRGB, regardless of LED strand color order.
uint32_t Ws2812bSingleBuffer::Color(uint8_t r, uint8_t g, uint8_t b, uint8_t w) {
  return ((uint32_t)w << 24) | ((uint32_t)r << 16) | ((uint32_t)g <<  8) | b;
}


uint16_t Ws2812bSingleBuffer::numPixels(void) const {
  return numLEDs;
}
...
void Ws2812bSingleBuffer::setBrightness(uint8_t b) {
...
uint8_t Ws2812bSingleBuffer::getBrightness(void) const {
  return brightness - 1;
}
...
*/
void Ws2812bSingleBuffer::clear() 
{
